  ...
  return <section>
      <div className="container grid grid-cols-1 md:grid-cols-2 gap-[30px] place-items-center pt-[100px] pb-[50px]">
          ...
          <div className="text-white">
              ...
              <a href="/" className="text-primary  hover:text-[#42b0d1] transition-colors border-b-2 border-primary border-solid pb-[5px] flex items-center gap-[15px] duration-200 w-fit " >See how Fylo works
              <img src="/src/assets/images/icon-arrow.svg" alt="icon-arrow" className="w-[20px] h-[20px] object-contain animate-[moveRight_1s_ease-in-out_infinite]" />
